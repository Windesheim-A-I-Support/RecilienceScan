...
- [Project Title](#project-title)
  ...
  - [Frequent Problems](#frequent-problems)
    - [Send\_email doesnt work](#send_email-doesnt-work)
  - [📌 Objective](#-objective)
  - [🧬 Motivation \& Methodology](#-motivation--methodology)
    - [Motivation](#motivation)
    - [Methodology](#methodology)
  - [🔎 Project Need](#-project-need)
    - [Pain Points in the Current Workflow](#pain-points-in-the-current-workflow)
  ...
  - [💡 Use Cases](#-use-cases)
    ...
    - [Ultimate Vision Use Case](#ultimate-vision-use-case)
  - [🛠️ Scope \& Non-Goals](#️-scope--non-goals)
    - [In Scope (for current milestone M1)](#in-scope-for-current-milestone-m1)
    - [Out of Scope (for now, future milestones)](#out-of-scope-for-now-future-milestones)
  - [📈 Roadmap (Milestones)](#-roadmap-milestones)
    - [**M1 — Feature Release One (Current)**](#m1--feature-release-one-current)
    - [**M2 — Semi-Automated Local Flow**](#m2--semi-automated-local-flow)
    - [**M3 — CI/CD Integration**](#m3--cicd-integration)
    - [**M4 — Automated Delivery**](#m4--automated-delivery)
    - [**M5 — Open-Source Survey Integration**](#m5--open-source-survey-integration)
    - [**M6 — Full Open-Source Survey Pipeline**](#m6--full-open-source-survey-pipeline)
  - [🏗️ Architecture Overview](#️-architecture-overview)
  - [🗂️ Directory Structure](#️-directory-structure)
    - [Components (Summary)](#components-summary)
  - [⚙️ Technical Proposal](#️-technical-proposal)
    - [Ingestion](#ingestion)
    - [Validation \& Transformation](#validation--transformation)
    - [Reporting](#reporting)
    - [Delivery](#delivery)
    - [Storage \& Archival](#storage--archival)
...
- [or](#or)
  ...
  - [🔧 Configuration](#-configuration)
    ...
    - [Recipients Mapping (`config/recipients.csv`)](#recipients-mapping-configrecipientscsv)
    - [Validation Schema (`config/schema.json`)](#validation-schema-configschemajson)
    - [Business Rules (`config/rules.yml`)](#business-rules-configrulesyml)
    - [Environment Variables](#environment-variables)
    - [Branding \& Templates](#branding--templates)
  - [👩‍🔬 Researcher/End-User Acceptance Test](#-researcherend-user-acceptance-test)
  - [👩‍🔬 Researcher/End-User Acceptance Test](#-researcherend-user-acceptance-test-1)
  ...
  - [🏛️ Compliance \& Branding](#️-compliance--branding)
