...
analyze_pillar_gap <- function(prefix) {
  ...
  high_examples <- get_examples(highest_dim, TRUE)
  low_examples <- get_examples(lowest_dim, FALSE)
...
## `r if (detected_language == "dutch") "Gedetailleerde Gap Analyse" else "Detailed Gap Analysis"` {.unnumbered}

::: {layout-ncol=3}

::: {.card}
### `r if (detected_language == "dutch") "🔵 Upstream Resilientie" else "🔵 Upstream Resilience"`

::: {.callout-warning appearance="minimal"}
**`r if (detected_language == "dutch") "Grootste verschil tussen" else "Largest gap between"`** `r up_analysis$lowest_dim` (`r sprintf("%.1f", up_analysis$lowest_score)`) **`r if (detected_language == "dutch") "en" else "and"`** `r up_analysis$highest_dim` (`r sprintf("%.1f", up_analysis$highest_score)`)
:::

**`r if (detected_language == "dutch") paste("✅ Hoog niveau", up_analysis$highest_dim) else paste("✅ High", up_analysis$highest_dim)`:**

- `r up_analysis$high_examples[1]`
- `r up_analysis$high_examples[2]`

**`r if (detected_language == "dutch") paste("⚠️ Lager niveau", up_analysis$lowest_dim) else paste("⚠️ Lower", up_analysis$lowest_dim)`:**

- `r up_analysis$low_examples[1]`
- `r up_analysis$low_examples[2]`
:::

::: {.card}
### `r if (detected_language == "dutch") "🟡 Interne Resilientie" else "🟡 Internal Resilience"`

::: {.callout-warning appearance="minimal"}
**`r if (detected_language == "dutch") "Grootste verschil tussen" else "Largest gap between"`** `r in_analysis$lowest_dim` (`r sprintf("%.1f", in_analysis$lowest_score)`) **`r if (detected_language == "dutch") "en" else "and"`** `r in_analysis$highest_dim` (`r sprintf("%.1f", in_analysis$highest_score)`)
:::

**`r if (detected_language == "dutch") paste("✅ Hoog niveau", in_analysis$highest_dim) else paste("✅ High", in_analysis$highest_dim)`:**

- `r in_analysis$high_examples[1]`
- `r in_analysis$high_examples[2]`

**`r if (detected_language == "dutch") paste("⚠️ Lager niveau", in_analysis$lowest_dim) else paste("⚠️ Lower", in_analysis$lowest_dim)`:**

- `r in_analysis$low_examples[1]`
- `r in_analysis$low_examples[2]`
:::

::: {.card}
### `r if (detected_language == "dutch") "🟢 Downstream Resilientie" else "🟢 Downstream Resilience"`

::: {.callout-warning appearance="minimal"}
**`r if (detected_language == "dutch") "Grootste verschil tussen" else "Largest gap between"`** `r do_analysis$lowest_dim` (`r sprintf("%.1f", do_analysis$lowest_score)`) **`r if (detected_language == "dutch") "en" else "and"`** `r do_analysis$highest_dim` (`r sprintf("%.1f", do_analysis$highest_score)`)
:::

**`r if (detected_language == "dutch") paste("✅ Hoog niveau", do_analysis$highest_dim) else paste("✅ High", do_analysis$highest_dim)`:**
- `r do_analysis$high_examples[1]`
- `r do_analysis$high_examples[2]`

**`r if (detected_language == "dutch") paste("⚠️ Lager niveau", do_analysis$lowest_dim) else paste("⚠️ Lower", do_analysis$lowest_dim)`:**
- `r do_analysis$low_examples[1]`
- `r do_analysis$low_examples[2]`
:::
